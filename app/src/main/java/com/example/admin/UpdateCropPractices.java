...
public class UpdateCropPractices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_crop_practices);

        cultiupdimg=findViewById(R.id.pracupdimg);
        cultiupddisc=findViewById(R.id.practiupddisc);
        cultiupdsubmit=findViewById(R.id.practiupdsubmit);
        cultiupdtitle=findViewById(R.id.practiupdtitle);
...
//                        progressBar.setVisibility(View.VISIBLE);
                            final StorageReference reference = storage.getReference()
                                    .child("Updatecroppractices/"+datakey);
...
//                    {
                        HashMap<String, Object> hashMap = new HashMap<>();
                        hashMap.put("readdata",cultiupddisc.getText().toString());
                        hashMap.put("readimg",Readimg);
                        hashMap.put("readname",cultiupdtitle.getText().toString());
...
//                    hashMap.put("userkey", uidd);
                        ...
                        ref.child(Readkey)
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Toast.makeText(getApplicationContext(), "Crop Practices Changed", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
                                });
                    }else
