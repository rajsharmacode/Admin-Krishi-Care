...
public class FullCropPractices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_crop_practices);

        culresimg=findViewById(R.id.pracresimg);
        culrestitle=findViewById(R.id.pracrestitle);
        culresdisc=findViewById(R.id.precresdisc);
        culresdelete=findViewById(R.id.precresdelete);
        culresupdate=findViewById(R.id.precresupdate);
        ...
        String Readkey=getIntent().getStringExtra("calkey1");
...
//
        ...
        reference.child("ReadPractices").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                caldisc = dataSnapshot.child(Readkey).child("readdata").getValue(String.class);
                calimg = dataSnapshot.child(Readkey).child("readimg").getValue(String.class);
                culname = dataSnapshot.child(Readkey).child("readname").getValue(String.class);
...
//        });
        ...
        culresupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i1=new Intent(getApplicationContext(), UpdateCropPractices.class);
...
//
        ...
        culresdelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("Do You Want to Delete this Crop practices");
...
//                                .child(getRef(position).getKey()).removeValue();
                        ...
                        if(Readkey!=null)
                        {
                            FirebaseDatabase.getInstance().getReference().child("ReadPractices").child(Readkey).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void unused) {
//                                    Intent i=new Intent(getApplicationContext(),CropPracticesPage.class);
//                                    startActivity(i);
                                    finish();
