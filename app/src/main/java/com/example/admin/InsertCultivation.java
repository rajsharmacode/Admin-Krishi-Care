...
import com.example.admin.InsertUserPage;
...
public class InsertCultivation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insert_cultivation);
...
//                        progressBar.setVisibility(View.VISIBLE);
                            final StorageReference reference = storage.getReference()
                                    .child("InsertCultivation/"+datakey);
...
//                    String uidd=user.getUid();
                    ...
                    if(userkey2==null)
                    {
                        ...
                        }else
                        {
                            ...
                            hashMap.put("caltdisc", culinsdisc.getText().toString());
                            hashMap.put("caltimg", temp.toString());
                            hashMap.put("caltname", culinstitle.getText().toString());
                            hashMap.put("calkey", userkey2);
                            ...
                            ref.child(userkey2)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            Toast.makeText(getApplicationContext(), "Cultivation inserted", Toast.LENGTH_SHORT).show();
                                            finish();
                                        }
                                    });
                        }
